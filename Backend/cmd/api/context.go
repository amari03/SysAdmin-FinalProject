...
func (app *applicationDependencies) contextSetUser(r *http.Request, user *data.User) *http.Request {
...
func (app *applicationDependencies) contextGetUser(r *http.Request) *data.User {
