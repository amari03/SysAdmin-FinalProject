...
func (a *applicationDependencies) routes() http.Handler {
	...
	router.HandlerFunc(http.MethodPost, "/v1/moodnotes", a.requireAuthenticatedUser(a.createMoodNoteHandler))
	router.HandlerFunc(http.MethodGet, "/v1/moodnotes", a.requireAuthenticatedUser(a.listMoodNotesHandler))
	router.HandlerFunc(http.MethodPatch, "/v1/moodnotes/:id", a.requireAuthenticatedUser(a.updateMoodNoteHandler))
	router.HandlerFunc(http.MethodDelete, "/v1/moodnotes/:id", a.requireAuthenticatedUser(a.deleteMoodNoteHandler))
